...
const Footer = () => {
  return (
    <footer className='ot-12 xl:pt-24 bg-primary text-white text-center'>
      ...
      {/* copyright */}
      <div className='py-6 border-r border-white/5 text-white/60'>
        Copyright &copy; 2024 ILoveMangás. All rights reserved.
      </div>
    </footer>
  );
};
